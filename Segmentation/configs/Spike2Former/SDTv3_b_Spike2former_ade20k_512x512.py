...
checkpoint_file = '/public/liguoqi/lzx/ckpt/sdtv3/E_19M_T4_checkpoint-197.pth'
...
train_dataloader = dict(batch_size=12, num_workers=16, dataset=dict(pipeline=train_pipeline))
# # In MaskFormer implementation we use batch size 2 per GPU as default
...
# load_from = '/public/liguoqi/lzx/code/project/mmseg1/tools/work_dirs/SDTv3_b_Spike2former_ade20k_512x512/best_mIoU_iter_37500.pth'
